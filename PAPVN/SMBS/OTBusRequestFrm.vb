...
Imports QRCoder
Public Class OTBusRequestFrm
    Dim conn As MySqlConnection
    Dim command As MySqlCommand
    Private Sub OTBusRequestFrm_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        EmployeeIDTbx.Text = SBMS_WCStaffFrm.EmployeeIdLabel.Text
    End Sub

    Private Sub Radio_btn_No1_CheckedChanged(sender As Object, e As EventArgs)
    ...
    Private Sub Radio_btn_Yes1_CheckedChanged(sender As Object, e As EventArgs)
