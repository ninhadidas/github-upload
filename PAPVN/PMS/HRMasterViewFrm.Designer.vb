...
Partial Class HRMasterViewFrm
    ...
    Private Sub InitializeComponent()
        ...
        Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(HRMasterViewFrm))
    ...
    " above (if any)"
        ...
        Me.GroupBox3.Location = New System.Drawing.Point(16, 35)
        ...
        Me.Name = "HRMasterViewFrm"
        Me.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen
        Me.Text = "PERFORMANCE MANAGEMENT SYSTEM - HR MASTER VIEW"
    ...
    Private Sub HRMasterViewFrm_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        PeriodLabel.Text = MasterGridUser.PeriodLabel.Text
        ...
        username = MasterGridUser.DataGridView.CurrentRow.Cells(1).Value.ToString
        ...
        If status <= 1 Or status = 4 Then
            Dim result As DialogResult = MessageBox.Show("Staff has not yet completed input targets/ self-assessment, do you want to view this?", "Targets/Self-Assessment not yet submitted", MessageBoxButtons.YesNo, MessageBoxIcon.Question)
