...
Public Class ForgotPwMngFrm
    ...
    Private Sub ResetPwBtn_Click(sender As Object, e As EventArgs) Handles ResetPwBtn.Click
        ...
        Else
            ...
            Dim name As String
            Dim link As String
            link = "<a href=""C:\Users\Admin\source\repos\PAPVN\PAPVN\bin\Debug\PAPVN.exe"">Click here</a>"
            ...
            Try
                conn.Open()
                Dim query As String = "SELECT * FROM manager WHERE email = '" & email & "';"
                ...
                If count = 1 Then
                    ...
                    reader.Close()
                    Dim query2 As String = "SELECT * FROM employee where email = '" & email & "';"
                    ...
                    If count = 1 Then
                        ...
                        reader.Close()
                    Else
                        Dim query_update As String = "UPDATE manager SET password= '" & temppw & "' WHERE email = '" & email & "';"
                        command = New MySqlCommand(query_update, conn)
                        reader = command.ExecuteReader
                        reader.Close()
                    End If
                    ...
                    sendmail.Body = "Dear Mr/Ms " & name & ", " & vbNewLine & " " & vbNewLine & "Your PMS password was reset to " & temppw & "" & vbNewLine & "Remember to use your EmployeeID (600xxxx - For Vietnamese) or GlobalID (For Japanese) as UserID!" & vbNewLine & "" & link & " to open the app and review." & vbNewLine & "Thank you!" & vbNewLine & "" & vbNewLine & "*This message is automatically sent from system."
