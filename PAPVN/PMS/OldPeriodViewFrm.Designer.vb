...
Partial Class OldPeriodViewFrm
    ...
    Private Sub InitializeComponent()
        ...
        Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(OldPeriodViewFrm))
    ...
    " above (if any)"
        ...
        Me.Name = "OldPeriodViewFrm"
        Me.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen
        Me.Text = "PERFORMANCE MANAGEMENT SYSTEM - VIEW OLD PERIOD"
    ...
    Private Sub OldPeriodViewFrm_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        DeptLabel.Text = WelcomeStaffFrm.DeptLabel.Text
        NameLabel.Text = WelcomeStaffFrm.NameLabel.Text
        ...
        Try
            ...
            If count = 1 Then
                ...
                ComScrLbl.Text = reader("competency").ToString
