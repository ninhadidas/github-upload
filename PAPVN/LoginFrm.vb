...
Public Class LoginFrm
    ...
    Private Sub Login_Click(sender As Object, e As EventArgs) Handles Login.Click
        ...
        conn = New MySqlConnection With {
            .ConnectionString = System.Configuration.ConfigurationManager.ConnectionStrings("loginConnectionString").ConnectionString
        }
        ...
        Try
            ...
            If count = 1 Then
                ...
                Dim pms As String
                pms = reader("pms").ToString
                If pms = True Then
                    MainFrm.PMS.Enabled = True
                    Label1.Enabled = True
                    Dim 
                End If
                ...
                MainFrm.Show()
                MainFrm.NameLb.Text = reader("name").ToString + "!"
